...
require_capability('block/asp:manage', context_system::instance());


$PAGE->set_context(context_system::instance());
$PAGE->set_pagelayout('standard');
$PAGE->set_url('/blocks/asp/movestep.php', array('stepid' => $stepid, 'direction' => $direction));
...
if ($direction == 'up') {
    ...
    $swapwith->load_asp_stepno($step->aspid, $stepno - 1);

} else {
    try {
        $swapwith->load_asp_stepno($step->aspid, $stepno + 1);
    } catch (block_asp_invalid_asp_step_exception $e) {
