...
$email   = new block_asp_email($emailid);
$email->require_deletable();

// The confirmation strings.
$confirmstr = get_string('deleteemailcheck', 'block_asp', $email->shortname);
$confirmurl = new moodle_url('/blocks/asp/deleteemail.php', array('emailid' => $emailid, 'confirm' => 1));
$returnurl  = new moodle_url('/blocks/asp/manage.php');

// Set the page and return urls.
$PAGE->set_url('/blocks/asp/deleteemail.php', array('emaild' => $emailid));

// Set the heading and page title.
$title = get_string('confirmemaildeletetitle', 'block_asp', $email->shortname);
$PAGE->set_title($title);
$PAGE->set_heading($title);
$PAGE->navbar->add(get_string('deletetemplate', 'block_asp'));
