 ...
 *
 */
class block_asp_command_setactivitysetting extends block_asp_command {
    public function parse($args, $step, $state = null) {
        ...
        if (!$dbman->field_exists($data->table, $data->column)) {
            $data->errors[] = get_string('invalidactivitysettingcolumn', 'block_asp', $data->column);
            return $data;
        }
