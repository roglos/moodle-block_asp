...
/**
 * ASP script command to assign a role.
 *
 * @package   block_asp
 ...
 *
 */
class block_asp_command_assignrole extends block_asp_command {
    /**
    ...
    public function execute($args, $state) {
        ...
        foreach ($data->users as $user) {
            role_assign($data->newrole->id, $user->id, $data->context->id, 'block_asp', $state->id);
        }
    }
}
