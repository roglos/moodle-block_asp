YUI.add('moodle-block_asp-userinfo', function (Y, NAME) {
...
/**
 * User info functionality for a popup in asp block.
 *
 * @package   block_asp
...
M.block_asp = M.block_asp || {};
M.block_asp.userinfo = M.block_asp.userinfo || {};
M.block_asp.userinfo.init = function() {
    return new POPUP();
};
